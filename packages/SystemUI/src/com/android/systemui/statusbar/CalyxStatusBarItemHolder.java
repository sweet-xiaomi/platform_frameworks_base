...
public class CalyxStatusBarItemHolder extends RelativeLayout
        implements CalyxStatusBarItem.Manager {
    private static final String TAG = "CalyxStatusBarItemHolder";

    private ArrayList<CalyxStatusBarItem.DarkReceiver> mDarkReceivers =
            new ArrayList<CalyxStatusBarItem.DarkReceiver>();
    private ArrayList<CalyxStatusBarItem.VisibilityReceiver> mVisibilityReceivers =
            new ArrayList<CalyxStatusBarItem.VisibilityReceiver>();
    ...
    public CalyxStatusBarItemHolder(Context context) {
        this(context, null);
    }

    public CalyxStatusBarItemHolder(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CalyxStatusBarItemHolder(Context context, AttributeSet attrs, int defStyle) {
    ...
    private DarkReceiver mDarkReceiver = new DarkReceiver() {
        ...
        public void onDarkChanged(Rect area, float darkIntensity, int tint) {
            ...
            mLastTint = tint;
            for (CalyxStatusBarItem.DarkReceiver r : mDarkReceivers) {
    ...
    private void updateVisibilityReceivers(boolean isVisible) {
        ...
        for (CalyxStatusBarItem.VisibilityReceiver r : mVisibilityReceivers) {
            r.onVisibilityChanged(mItemHolderIsVisible);
        }
    }

    // CalyxStatusBarItem.Manager methods

    public void addDarkReceiver(CalyxStatusBarItem.DarkReceiver darkReceiver) {
    ...
    public void addVisibilityReceiver(CalyxStatusBarItem.VisibilityReceiver visibilityReceiver) {
