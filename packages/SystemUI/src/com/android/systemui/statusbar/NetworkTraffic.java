...
public class NetworkTraffic extends TextView {
    ...
    private CalyxStatusBarItem.DarkReceiver mDarkReceiver =
            new CalyxStatusBarItem.DarkReceiver() {
    ...
    private CalyxStatusBarItem.VisibilityReceiver mVisibilityReceiver =
            new CalyxStatusBarItem.VisibilityReceiver() {
    ...
    protected void onAttachedToWindow() {
        ...
        CalyxStatusBarItem.Manager manager =
                CalyxStatusBarItem.findManager((View) this);
